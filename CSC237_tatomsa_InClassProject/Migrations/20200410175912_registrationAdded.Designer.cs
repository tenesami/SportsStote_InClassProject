...
namespace CSC237_tatomsa_InClassProject.Migrations
{
    ...
    [Migration("20200410175912_registrationAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CSC237_tatomsa_InClassProject.Models.Country", b =>
                {
            ...
            modelBuilder.Entity("CSC237_tatomsa_InClassProject.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("CSC237_tatomsa_InClassProject.Models.Incident", b =>
                {
            ...
            modelBuilder.Entity("CSC237_tatomsa_InClassProject.Models.Product", b =>
                {
                    b.Property<int>("ProductID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CSC237_tatomsa_InClassProject.Models.Registration", b =>
                {
                    b.Property<int>("CustomerID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CSC237_tatomsa_InClassProject.Models.Technician", b =>
                {
                    b.Property<int>("TechnicianID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CSC237_tatomsa_InClassProject.Models.Customer", b =>
                {
                    b.HasOne("CSC237_tatomsa_InClassProject.Models.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("CSC237_tatomsa_InClassProject.Models.Incident", b =>
                {
                    b.HasOne("CSC237_tatomsa_InClassProject.Models.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CSC237_tatomsa_InClassProject.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CSC237_tatomsa_InClassProject.Models.Technician", "Technician")
                        .WithMany()
